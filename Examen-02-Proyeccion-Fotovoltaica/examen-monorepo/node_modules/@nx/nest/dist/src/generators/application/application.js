...
const assert_supported_nestjs_version_1 = require("../../utils/assert-supported-nestjs-version");
...
async function applicationGeneratorInternal(tree, rawOptions) {
    (0, assert_supported_nestjs_version_1.assertSupportedNestJsVersion)(tree);
