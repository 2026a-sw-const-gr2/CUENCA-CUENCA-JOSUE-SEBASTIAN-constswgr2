...
export class EventsService {
  ...
  async registerEvent(dto: CreateEventDto): Promise<{ ok: boolean }> {
    ...
    if (action === 'CREATE') {
      ...
      this.logger.log('Evento CREATE registrado correctamente');
      return { ok: true };
    }
    ...
    if (action === 'UPDATE') {
      ...
      this.logger.log('Evento UPDATE registrado correctamente');
      return { ok: true };
    }
  ...
  this.logger.log('Evento DELETE registrado correctamente');
  return { ok: true };
}
    ...
    if (action === 'QUERY') {
      ...
      this.logger.log('Evento QUERY registrado correctamente');
      return { ok: true };
    }
